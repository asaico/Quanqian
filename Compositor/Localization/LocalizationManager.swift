...
enum LocalizationTable {
    ...
    private static let chineseTable: [String: String] = [
        ...
        // MARK: - 侧边栏与停靠面板 (Dockable Panels)
        "Right Sidebar": "右侧边栏",
        "Left Sidebar": "左侧边栏",
        "Floating Window": "浮动窗口",
        "Dock to Right Sidebar": "嵌入到右侧边栏",
        "Dock to Left Sidebar": "嵌入到左侧边栏",
        "Pop out to Window": "弹出为浮动窗口",
        "Close Panel": "关闭面板",
        "Panel Options": "面板选项",
        ...
        // MARK: - 侧边栏分区 (Sidebar Sections)
        "Top Section": "上部分区",
        "Middle Section": "中部分区",
        "Bottom Section": "下部分区",
        "Move to Top Section": "移动到上部分区",
        "Move to Middle Section": "移动到中部分区",
        "Move to Bottom Section": "移动到下部分区",

        // MARK: - 画面原位文字编辑 (On-Canvas Text Editing)
        "Edit on Canvas": "在画面上编辑",
        "Edit Text on Canvas": "在画面上编辑文字",
        "Finish Editing": "完成编辑",
        "Cancel Editing": "取消编辑",
        "Press Return or ⌘⏎ to finish, Esc to cancel": "按回车或 ⌘⏎ 完成，Esc 取消",
        "Leading (Column Gap)": "行距 (列距)",
        "Tracking (Char Gap)": "字距 (字间距)",

        // MARK: - 工具与子选项 (Tools & Subtools)
        "Gradient Tool (G)": "渐变工具 (G)",
        "Paint Bucket Tool (G)": "油漆桶工具 (G)",
        "Paint Bucket": "油漆桶",
        "Fill Foreground": "填充前景色",
        "Fill Background": "填充背景色",
        "Fill selection or layer with foreground color (⌥⌫)": "用前景色填充选区或图层 (⌥⌫)",
        "Fill selection or layer with background color (⌘⌫)": "用背景色填充选区或图层 (⌘⌫)",
        "Type Tool (T)": "文字工具 (T)",
        "Type Tool": "文字工具",
        "Horizontal Type Tool (T)": "横排文字工具 (T)",
        "Vertical Type Tool (T)": "竖排文字工具 (T)",
        "Horizontal Type Tool": "横排文字工具",
        "Vertical Type Tool": "竖排文字工具",
        "Toggle Horizontal / Vertical Type (⇧T)": "切换横排 / 竖排文字 (⇧T)",
        "Rectangular Marquee Tool (M)": "矩形选框工具 (M)",
        "Elliptical Marquee Tool (M)": "椭圆选框工具 (M)",
        "Lasso Tool (L)": "套索工具 (L)",
        "Polygonal Lasso Tool (L)": "多边形套索工具 (L)",
        "Brush Tool (B)": "画笔工具 (B)",
        "Eraser Tool (E)": "橡皮擦工具 (E)",
        "Rectangle Tool (U)": "矩形工具 (U)",
        "Ellipse Tool (U)": "椭圆工具 (U)",
        "Rounded Rectangle Tool (U)": "圆角矩形工具 (U)",

        // MARK: - 快捷键与操作偏好设置 (Shortcuts & Gestures)
        "Shortcuts & Operations": "快捷键与操作",
        "Canvas Zoom Mode": "画布缩放模式",
        "Zoom Sensitivity": "缩放灵敏度",
        "Invert Zoom Direction": "反转滚轮缩放方向",
        "Tip: In default mode, hold Command or Option while scrolling to zoom the canvas.": "提示：默认模式下，按住 Command 或 Option 滚动滚轮即可缩放画布。",
        "Canvas Zoom & Gestures": "画布缩放与操作习惯",
        "Tool / Action": "工具 / 操作",
        "Shortcut": "快捷键",
        "Photoshop-Compatible Tool Shortcuts": "Photoshop 兼容工具快捷键",
        "Reset Operations & Shortcuts to Defaults": "恢复操作与快捷键为默认设置",
        "Type Tool / Horizontal & Vertical": "文字工具 / 横排与竖排",
        "Move / Transform Tool": "移动 / 自由变换工具",
        "Brush / Eraser Tool": "画笔 / 橡皮擦工具",
        "Gradient / Paint Bucket Tool": "渐变 / 油漆桶工具",
        "Rectangular / Elliptical Marquee": "矩形 / 椭圆选框工具",
        "Freehand / Polygonal Lasso": "套索 / 多边形套索工具",
        "Magic Wand Tool": "魔棒工具",
        "Crop Tool": "裁剪工具",
        "Spot Healing Brush": "污点修复画笔",
        "Clone Stamp Tool": "仿制图章工具",
        "Smear / Blur Tool": "涂抹 / 模糊工具",
        "Shape Tool (Rect / Ellipse / Round)": "形状工具 (矩形/椭圆/圆角矩形)",
        "Eyedropper Tool": "吸管工具",
        "Hand Tool / Pan Canvas": "抓手工具 / 空格拖动画布",
        "Zoom Tool": "缩放工具",
        "Command + 滚轮缩放 (默认)": "Command + 滚轮缩放 (默认)",
        "Option + 滚轮缩放": "Option + 滚轮缩放",
        "直接滚轮缩放 (无需按键)": "直接滚轮缩放 (无需按键)",
        "关闭滚轮缩放": "关闭滚轮缩放"
    ]
}
